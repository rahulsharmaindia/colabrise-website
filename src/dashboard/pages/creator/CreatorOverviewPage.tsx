    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-dark-800 p-6 shadow-2xl">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-base font-semibold text-gray-900 dark:text-white">Edit Niches</h3>
          <button onClick={onCancel} className="text-gray-400 hover:text-gray-900 dark:hover:text-white" aria-label="Close">
            <X className="w-5 h-5" />
          </button>
        </div>
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">Select up to 3 niches that describe your content.</p>
        ...
        <p className="text-xs text-gray-400 dark:text-gray-500 mb-4">{current.length}/3 selected</p>
...
function EditProfileModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
      ...
      <div className="relative w-full max-w-lg rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-dark-800 p-6 shadow-2xl my-8 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-400 dark:text-gray-600 mt-1">{(form.bio ?? '').length}/300</p>
          </div>

          {/* Niche */}
          <div>
            <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Primary Niche</label>
            <select
              value={form.niche ?? ''}
              onChange={(e) => updateField('niche', e.target.value)}
              className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500/40"
            >
          ...
          {/* Pricing Section */}
          <div>
            <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">Rate Card (INR)</label>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-[10px] text-gray-400 dark:text-gray-500 mb-1">Per Reel</label>
                <input
                  type="number"
                  min={0}
              ...
              <div>
                <label className="block text-[10px] text-gray-400 dark:text-gray-500 mb-1">Per Post</label>
                <input
                  type="number"
                  min={0}
              ...
              <div>
                <label className="block text-[10px] text-gray-400 dark:text-gray-500 mb-1">Per Story</label>
                <input
                  type="number"
                  min={0}
              ...
              <div>
                <label className="block text-[10px] text-gray-400 dark:text-gray-500 mb-1">Ad Rights (15 days)</label>
                <input
                  type="number"
                  min={0}
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900 dark:text-white">My Profile</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Your creator profile overview.</p>
        </div>
      ...
      <DashCard>
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
          ...
          <div className="relative shrink-0">
            <div className="w-20 h-20 rounded-full p-[3px] bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400">
              {profile.profilePictureUrl ? (
                ...
                <div className="w-full h-full rounded-full bg-white dark:bg-dark-800 flex items-center justify-center border-2 border-dark-800">
          ...
          <div className="flex-1 text-center sm:text-left">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{resolvedName}</h2>
            {profile.username && (
            ...
            <div className="flex flex-wrap items-center gap-1.5 mt-3 justify-center sm:justify-start">
              ...
              <button
                ...
                className="text-xs text-gray-400 dark:text-gray-500 hover:text-purple-400 transition-colors px-1.5"
            ...
            <div className="flex items-center gap-6 mt-4 justify-center sm:justify-start">
              <div className="text-center">
                <p className="text-lg font-semibold text-gray-900 dark:text-white">{formatCount(followerCount)}</p>
                <p className="text-[10px] text-gray-400 dark:text-gray-500">Followers</p>
              </div>
              <div className="text-center">
                <p className="text-lg font-semibold text-gray-900 dark:text-white">{formatCount(profile.followsCount)}</p>
                <p className="text-[10px] text-gray-400 dark:text-gray-500">Following</p>
              </div>
              <div className="text-center">
                <p className="text-lg font-semibold text-gray-900 dark:text-white">{formatCount(profile.mediaCount)}</p>
        ...
        {(profile.bio || profile.biography) && (
          <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed mt-4 pt-4 border-t border-gray-100 dark:border-white/5">
            {profile.bio || profile.biography}
          </p>
        )}
      </DashCard>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-900 dark:text-white">{profile.email ?? 'Not provided'}</p>
                <p className="text-[10px] text-gray-400 dark:text-gray-500">Email</p>
              </div>
            </div>
            {profile.email && (
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-900 dark:text-white">{profile.contactNumber ?? 'Not provided'}</p>
                <p className="text-[10px] text-gray-400 dark:text-gray-500">Phone</p>
              </div>
            </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <button
          ...
          className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-dark-800 p-4 flex flex-col items-center gap-2 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors"
        >
          <div className="w-10 h-10 rounded-lg bg-purple-500/10 flex items-center justify-center">
            <BarChart3 className="w-5 h-5 text-purple-400" />
          </div>
          <span className="text-xs font-medium text-gray-700 dark:text-gray-300">Campaigns</span>
        </button>
        <button
        ...
        >
          ...
          <span className="text-xs font-medium text-gray-700 dark:text-gray-300">Brands</span>
        </button>
        <button
          disabled
          className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-dark-800 p-4 flex flex-col items-center gap-2 opacity-50 cursor-not-allowed"
        >
          <div className="w-10 h-10 rounded-lg bg-emerald-500/10 flex items-center justify-center">
            <Wallet className="w-5 h-5 text-emerald-400" />
          </div>
          <span className="text-xs font-medium text-gray-400 dark:text-gray-500">Wallet</span>
          <span className="text-[9px] text-gray-400 dark:text-gray-600">Coming soon</span>
        </button>
        <button
          disabled
          className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-dark-800 p-4 flex flex-col items-center gap-2 opacity-50 cursor-not-allowed"
        >
          ...
          <span className="text-xs font-medium text-gray-400 dark:text-gray-500">Support</span>
          <span className="text-[9px] text-gray-400 dark:text-gray-600">Coming soon</span>
        </button>
      </div>
      ...
      {hasRateCard ? (
        <DashCard>
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Rate Card</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 p-3 text-center">
              <p className="text-base font-semibold text-gray-900 dark:text-white">{formatCurrency(profile.pricePerReel)}</p>
              <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5">Per Reel</p>
            </div>
            <div className="rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 p-3 text-center">
              <p className="text-base font-semibold text-gray-900 dark:text-white">{formatCurrency(profile.pricePerPost)}</p>
              <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5">Per Post</p>
            </div>
            <div className="rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 p-3 text-center">
              <p className="text-base font-semibold text-gray-900 dark:text-white">{formatCurrency(profile.pricePerStory)}</p>
              <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5">Per Story</p>
            </div>
            <div className="rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 p-3 text-center">
              <p className="text-base font-semibold text-gray-900 dark:text-white">{formatCurrency(profile.priceAdRights15Days)}</p>
              <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5">Ad Rights (15d)</p>
            </div>
          </div>
        </DashCard>
      ) : (
        <DashCard>
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Rate Card</h3>
              <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Set your pricing so brands can see your rates.</p>
            </div>
            <DashButton variant="secondary" size="sm" onClick={() => setShowEditModal(true)}>
              Set Rates
            </DashButton>
      ...
      {videoMedia.length > 0 && (
        <DashCard>
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">
            Reels & Videos
            <span className="ml-2 text-xs text-gray-400 dark:text-gray-500 font-normal">{videoMedia.length}</span>
          </h3>
          <div className="grid grid-cols-3 gap-2">
            {videoMedia.slice(0, 9).map((item) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="relative aspect-[9/16] rounded-lg overflow-hidden bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 group hover:border-purple-500/30 transition-colors"
              >
                {item.thumbnailUrl ? (
                  <img
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-2">
                  <div className="flex items-center gap-3 text-[10px] text-gray-900 dark:text-white">
                    {item.likeCount != null && (
                ...
                <div className="absolute top-2 right-2 bg-black/40 rounded-full p-1">
                  <Play className="w-3 h-3 text-gray-900 dark:text-white fill-white" />
                </div>
              </a>
            ))}
          </div>
      ...
      <DashCard>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            Delete Account
            <span className="ml-auto text-[10px] text-gray-400 dark:text-gray-600">Coming soon</span>
          </button>
        </div>
      </DashCard>
